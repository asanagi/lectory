...
const (
	...
	UserServiceName = "app.v1.UserService"
)
...
const (
	...
	UserServiceGetProfileProcedure = "/app.v1.UserService/GetProfile"
)
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_app_v1_user_proto.Services().ByName("UserService").Methods()
...
// GetProfile calls app.v1.UserService.GetProfile.
...
func (UnimplementedUserServiceHandler) GetProfile(context.Context, *connect.Request[v1.GetProfileRequest]) (*connect.Response[v1.GetProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app.v1.UserService.GetProfile is not implemented"))
}
